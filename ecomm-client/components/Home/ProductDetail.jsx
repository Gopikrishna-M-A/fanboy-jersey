...
const Products = ({ product }) => {
  ...
  return (
    ...
    <div>
      <div className='bg-gray-100 pt-2 pb-10'>
        <div className='flex flex-col items-center justify-center gap-2 '>
          <div className='flex items-center gap-3'>
            {images.image1 && (
              <Image
                className='border rounded-full aspect-square cursor-pointer '
                width={30}
                src={images.image1}
                objectFit='contain'
                onClick={() => setCurrentImage(1)}
      ...
      <div className='bg-white  rounded-t-3xl -mt-10 flex-grow pb-10  px-3 pt-4 flex flex-col'>
        <div className='flex justify-between'>
          ...
          <div className='flex flex-col items-start'>
            <Text delete className='text-gray-300'>
              ₹{product?.MRP}
            </Text>
